...
let package = Package(
    name: "MongoKitten",
    dependencies: [
                      .Package(url: "https://github.com/CryptoKitten/MD5.git", majorVersion: 0, minor: 5),
                      .Package(url: "https://github.com/CryptoKitten/SCRAM.git", majorVersion: 0, minor: 5),
                      .Package(url: "https://github.com/PlanTeam/BSON.git", majorVersion: 2, minor: 2),
