...
final public class MD5 : HashProtocol  {
    public static let size:Int = 16 // 128 / 8
    
    /** specifies the per-round shift amounts */
    public static let s: [UInt32] = [7, 12, 17, 22,  7, 12, 17, 22,  7, 12, 17, 22,  7, 12, 17, 22,
                               5,  9, 14, 20,  5,  9, 14, 20,  5,  9, 14, 20,  5,  9, 14, 20,
                               4, 11, 16, 23,  4, 11, 16, 23,  4, 11, 16, 23,  4, 11, 16, 23,
                               6, 10, 15, 21,  6, 10, 15, 21,  6, 10, 15, 21,  6, 10, 15, 21]
    
    /** binary integer part of the sines of integers (Radians) */
    public static let k: [UInt32] = [0xd76aa478,0xe8c7b756,0x242070db,0xc1bdceee,
    ...
    public static let h:[UInt32] = [0x67452301, 0xefcdab89, 0x98badcfe, 0x10325476]
